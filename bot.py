...
def main():
    ...
    try:
        ...
        if os.environ.get("PORT"):
            ...
            # Запускаем Telegram бота с удалением вебхука
            print("🤖 Запускаю Telegram бота...")
            
            # Создаем асинхронную функцию для запуска
            async def run_telegram_bot():
                # Удаляем старый вебхук перед запуском polling
...
if __name__ == "__main__":
    ...
    # Render САМ запускает Flask на порту из переменной PORT
    # Нам нужно только запустить Telegram бота
    
    if os.environ.get("PORT"):
        print("🌐 Запуск на Render обнаружен")
        print("🤖 Запускаю Telegram бота...")
        
        # Render уже запустил Flask, мы просто запускаем Telegram бота
        main()
    else:
        # Локальный запуск - запускаем и Flask, и бота
        print("💻 Локальный запуск")
        
        # Запускаем Flask в отдельном потоке для локального тестирования
        from threading import Thread
        import time
